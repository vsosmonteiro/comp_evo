...
def mutateCromo(cromo):
    ...
    if random.randint(0, 100) > 50:
        mycromo.voice_gsm = random.randint(0, 125)
    if random.randint(0, 100) > 50:
        mycromo.voice_wcdma = random.randint(0, 150)
    if random.randint(0, 100) > 50:
        mycromo.data_gsm = random.randint(0, 30)
    if random.randint(0, 100) > 50:
        mycromo.data_wcdma = random.randint(0, 80)
